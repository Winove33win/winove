  ...
  return (
    <section id="services" className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-primary/3 rounded-full blur-3xl" style={{ animationDelay: '3s' }} />
      </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={service.title}
                  className={`glass rounded-2xl p-8 cursor-pointer transition-all duration-500 hover-lift animate-fade-in-up ${
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    <div className={`w-16 h-16 rounded-xl flex items-center justify-center mb-6 transition-all duration-300 ${
                      isHovered ? 'bg-gradient-primary scale-110' : 'bg-secondary'
                    }`}>
                    ...
                    <div className={`transition-all duration-300 ${
                      isHovered ? 'opacity-100 max-h-40' : 'opacity-70 max-h-0 overflow-hidden'
                    }`}>
